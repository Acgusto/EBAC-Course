...
function somarComRest(nome, sobrenome) {
...
var timesDeFutebolDeSaoPaulo = ['santos', 'palmeiras', 'bragantino', 'sao paulo'];
...
var timesDeFutebol = [].concat(timesDeFutebolDeSaoPaulo, timesDeFutebolDoRio);
...
console.log(item2);
console.log(item3);
(_console2 = console).log.apply(_console2, _toConsumableArray(outrosTimes));